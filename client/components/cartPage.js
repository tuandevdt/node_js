                    ...
                    ${carts.map(item => {
                        ...
                        <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 md:p-6">
                            ...
                            <a href="#" class="shrink-0 md:order-1">
                                <img class="h-20 w-20 dark:hidden" src="http://localhost:4000/${item.product.image}" alt="imac image" />
                            ...
                            <div class="flex items-center justify-between md:order-3 md:justify-end">
                                ...
                                <button type="button" id="increment-button-${item.id}" data-input-counter-increment="counter-input" class="inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border border-gray-300 bg-gray-100 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700">
                            ...
                            <div class="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                <a href="#" class="text-base font-medium text-gray-900 hover:underline dark:text-white">${item.product.name}</a> <br>
                                ...
                                <button type="button" id="delete-cart-${item.id}" class="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                                    <svg class="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div class="mx-auto mt-6 max-w-4xl flex-1 space-y-6 lg:mt-0 lg:w-full">
                    ...
                    <div class="space-y-4">
                        ...
                        <dl class="flex items-center justify-between gap-4">
                            ...
                            <dd class="text-base font-medium text-gray-900 dark:text-white">${formatCurrency(sumPrice)}</dd>
                        </dl>
                        ...
                        <dd class="text-base font-bold text-gray-900 dark:text-white">${formatCurrency(sumPrice)}</dd>
                        </dl>
                    </div>

                   <button class="flex w-full items-center justify-center rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                        <a href="/checkout">Proceed to Checkout</a>
                    </button>

                    <div class="flex items-center justify-center gap-2 mt-4">
                        <span class="text-sm font-normal text-gray-500 dark:text-gray-400">or</span>
                        <a href="#" title="" class="inline-flex items-center gap-2 rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-500 dark:hover:bg-blue-600 dark:focus:ring-blue-800">
                            Continue Shopping
