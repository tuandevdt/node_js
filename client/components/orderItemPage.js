            ...
            <div class="w-full max-w-7xl px-4 md:px-5 lg-6 mx-auto">
                ...
                <div class="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                    <div
                        ...
                        <div class="data">
                            <p class="font-semibold text-base leading-7 text-black">Order Id: <span class="text-indigo-600 font-medium">#000${orders[0].order_id}</span></p>
                    ...
                    <div class="w-full px-3 min-[400px]:px-6">
                        ${orders.map(item => {
                            ...
                            sumPrice += item.quantity * Number(item.price);
                            return `
                                <div class="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                                    <div class="img-box max-lg:w-full">
                                        <img src="http://localhost:4000/${item.product.image}" alt="${item.product.name}" 
                                            ...
                                            <div class="grid grid-cols-5">
                                                <div class="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                                    <div class="flex gap-3 lg:block">
                                                        ...
                                                        <p class="lg:mt-4 font-medium text-sm leading-7 text-indigo-600">${formatCurrency(item.price)}</p>
                                                    </div>
                                                </div>
                    ...
                    <div class="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                        ...
                        <p class="font-semibold text-lg text-black py-6">Total Price: <span class="text-indigo-600">${formatCurrency(sumPrice)}</span></p>
                    </div>
